...
# 66 "ADC_Multichannel.c" 2



unsigned int valor_ch[6];

void leer_canales_ADC(){

  ADCON0bits.CHS = 0;
  _delay((unsigned long)((10)*(20000000/4000000.0)));
  valor_ch[0] = ADC_Read(0);

  ADCON0bits.CHS = 1;
  _delay((unsigned long)((10)*(20000000/4000000.0)));
  valor_ch[1] = ADC_Read(1);

   ADCON0bits.CHS = 2;
  _delay((unsigned long)((10)*(20000000/4000000.0)));
  valor_ch[2] = ADC_Read(2);

   ADCON0bits.CHS = 3;
  _delay((unsigned long)((10)*(20000000/4000000.0)));
  valor_ch[3] = ADC_Read(3);

   ADCON0bits.CHS = 5;
  _delay((unsigned long)((10)*(20000000/4000000.0)));
  valor_ch[5] = ADC_Read(5);
...
void main()
{
    ...
    LATA = 0x00;
      ...
      leer_canales_ADC();
        ...
        if(valor_ch[1] > valor_ch[0]){
            LATDbits.LATD0 = 1;
        }else{
            LATDbits.LATD0 = 0;
        }

        if(valor_ch[2] > valor_ch[0]){
            LATDbits.LATD1 = 1;
        }else{
            LATDbits.LATD1 = 0;
        }

        if(valor_ch[3] > valor_ch[0]){
            LATDbits.LATD2 = 1;
        }else{
            LATDbits.LATD2 = 0;
        }

        if(valor_ch[5] > valor_ch[0]){
            LATDbits.LATD4 = 1;
        }else{
            LATDbits.LATD4 = 0;
        }
